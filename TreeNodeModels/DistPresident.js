...
const dpsschema = new mongoose.Schema({
    ...
    nowards:{type:String, required:false, trim:true},
    nobooth:{type:String, required:false, trim:true},
...
const DPSModel = mongoose.model('DPS_Data',dpsschema);

export default DPSModel